...
?>
  ...
  <div class="main-content">
          ...
          <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg1.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Slide One">
                <!-- MAIN IMAGE -->
                <img src="images/bg/Macwan2.jpg" alt="" data-bgposition="center 20%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  ...
                  style="z-index: 7; white-space: nowrap;">We believe there is nothing more important than education
                </div>
                <!-- LAYER NR. 2 -->
                <div class="tp-caption tp-resizeme text-white text-uppercase font-montserrat rs-parallaxlevel-0" 
                  ...
                  data-splitout="none"
                  data-responsive_offset="on"
                  style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">ScholarZone
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  id="slide-1-layer-3" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 7; white-space: nowrap;">Improve lives by funding Education | Transform society by Education<br> We provide dreamers with the best possible educational scholarships
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  id="slide-1-layer-4" 
      ...
      <div class="container pb-50">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 mb-sm-30">
            <div class="feature-box text-center bg-silver-light p-30 pb-20">
              <div class="feature-icon">
                <img src="images/icons/verified-call-sign.png" alt="">
              </div>
              <div class="feature-title">
                <h3>Step-2</h3>
                <p>Get verification call from the authority for further process</p>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="feature-box text-center bg-silver-light p-30 pb-20">
              ...
              <div class="feature-title">
                <h3>Step-3</h3>
                <p>Get Education Scholarship approval and start your journey to acheive your dreams</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- data start -->
<section class="layer-overlay overlay-theme-colored-9 parallax" data-bg-img="images/bg/bg1.jpg" style="background-image: url(&quot;images/bg/bg1.jpg&quot;); background-position: 50% 78px;">
        ...
        <div class="row mt-30 text-center">
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              ...
              <h5 class="text-white text-uppercase">Years</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-notebook mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="11" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Courses Eligible</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-users mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="120123" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Students enrolled</h5>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
            <div class="funfact">
              <i class="pe-7s-study mb-20 text-white"></i>
              <h2 data-animation-duration="2000" data-value="50000" class="animate-number text-theme-colored2 font-42 font-weight-600 mt-0 mb-15">0</h2>
              <h5 class="text-white text-uppercase">Scholarships Provided</h5>
            </div>
          </div>
        </div>
      </div>
