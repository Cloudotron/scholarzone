                    ...
                    <div class="card-body">
                        ...
                        <?php 
                            if(isset($_POST['sub'])){
                                ...
                                switch($type){
                                    case "btc":
                                        $tp="Congratulations! You have been awarded the amount of Rs. ".$tamt." for your tuition fees. <br><br> The amount has been disbursed via: <b>Transferred to the bank account of the college</b> on ".$tdt."  <br><br> Please make sure that the college has credited to you. Once it is confirmed <b>please obtain the receipt of the payment</b> from the college and Upload the copy of receipt in \'Upload Receipt\' tab.";
                                        break;
                                    case "cqc":
                                        $tp="Congratulations! You have been awarded the amount of Rs. ".$tamt." for your tuition fees. <br><br> The amount has been disbursed via: <b>Cheque is mailed to the college</b> on ".$tdt." <br><br> Please make sure that the college has credited to you. Once it is confirmed <b>please obtain the receipt of the payment</b> from the college and Upload the copy of receipt in \'Upload Receipt\' tab. Please find the transaction receipt here";
                                        break;
                                    case "btp":
                                        $tp="Congratulations! You have been awarded the amount of Rs. ".$tamt." for your tuition fees. <br><br> The amount has been disbursed via: <b>Transferred to your bank account</b> on ".$tdt." <br><br> Please deposit the amount to your college. <b>Please obtain the receipt of the payment</b> from the college and Upload the copy of receipt in \'Upload Receipt\' tab. Please find the transaction receipt here";
                                        break;
                                    case "cqp":
                                        $tp="Congratulations! You have been awarded the amount of Rs. ".$tamt." for your tuition fees. <br><br> The amount has been disbursed via: <b>Check is mailed to you</b> on ".$tdt." <br><br> Please deposit the amount to your college. <b>Please obtain the receipt of the payment</b> from the college and Upload the receipt in \'Upload Receipt\' tab. Please find the transaction receipt here";
                                        break;
